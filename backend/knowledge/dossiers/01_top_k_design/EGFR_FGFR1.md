# Novokine candidate dossier — EGFR + FGFR1
_Generated from experience buffer record `cf492749-8cd1-4e81-aa1f-2c152b6f452a` at 2026-05-04T07:07:21.529420+00:00 (mode=score_only)._

- **receptor_A:** `EGFR`
- **receptor_B:** `FGFR1`
- **linker:** `GS_med`
- **candidate_id:** `EGFR_FGFR1__GS_med`
- **tier:** **TOP_K_DESIGN**
