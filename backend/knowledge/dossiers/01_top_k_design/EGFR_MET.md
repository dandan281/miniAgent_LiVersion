# Novokine candidate dossier — EGFR + MET
_Generated from experience buffer record `8417562f-bfe2-4223-99db-1bab7c1f84cb` at 2026-05-04T07:07:21.534559+00:00 (mode=score_only)._

- **receptor_A:** `EGFR`
- **receptor_B:** `MET`
- **linker:** `GS_med`
- **candidate_id:** `EGFR_MET__GS_med`
- **tier:** **TOP_K_DESIGN**
