# Novokine candidate dossier — ERBB2 + FGFR4
_Generated from experience buffer record `43fb6a54-53e6-432a-8721-2df1aabfa16c` at 2026-05-04T07:07:21.525802+00:00 (mode=score_only)._

- **receptor_A:** `ERBB2`
- **receptor_B:** `FGFR4`
- **linker:** `GS_med`
- **candidate_id:** `ERBB2_FGFR4__GS_med`
- **tier:** **TOP_K_DESIGN**
