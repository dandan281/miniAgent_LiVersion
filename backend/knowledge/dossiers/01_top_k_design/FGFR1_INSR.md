# Novokine candidate dossier — FGFR1 + INSR
_Generated from experience buffer record `27aeca27-628a-44ae-94a3-f3f8c233dd8d` at 2026-05-04T07:07:21.537944+00:00 (mode=score_only)._

- **receptor_A:** `FGFR1`
- **receptor_B:** `INSR`
- **linker:** `GS_med`
- **candidate_id:** `FGFR1_INSR__GS_med`
- **tier:** **TOP_K_DESIGN**
