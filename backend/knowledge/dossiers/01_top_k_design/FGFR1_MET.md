# Novokine candidate dossier — FGFR1 + MET
_Generated from experience buffer record `726fe6b3-e08f-4761-a3c2-b86051ba0128` at 2026-05-04T07:07:21.539676+00:00 (mode=score_only)._

- **receptor_A:** `FGFR1`
- **receptor_B:** `MET`
- **linker:** `GS_med`
- **candidate_id:** `FGFR1_MET__GS_med`
- **tier:** **TOP_K_DESIGN**

## Mechanism narrative
Heuristic candidate from generate_candidates.py — class pair: (FGFR, MET); axis: myogenic; linker: GS_med (20 aa, flexible).

## Adaptor classification (biased output)
- **transphosphorylation adaptors:** `GRB2`, `FRS2`, `GAB1`, `STAT3`
