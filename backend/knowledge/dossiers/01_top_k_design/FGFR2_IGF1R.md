# Novokine candidate dossier — FGFR2 + IGF1R
_Generated from experience buffer record `714e9eb3-f909-46d9-ab53-d7d2cde74f8c` at 2026-05-04T07:07:21.541306+00:00 (mode=score_only)._

- **receptor_A:** `FGFR2`
- **receptor_B:** `IGF1R`
- **linker:** `GS_med`
- **candidate_id:** `FGFR2_IGF1R__GS_med`
- **tier:** **TOP_K_DESIGN**
