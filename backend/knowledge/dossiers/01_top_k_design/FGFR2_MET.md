# Novokine candidate dossier — FGFR2 + MET
_Generated from experience buffer record `6f114fab-6d43-4a34-b399-8e1097169ae0` at 2026-05-04T07:07:21.544781+00:00 (mode=score_only)._

- **receptor_A:** `FGFR2`
- **receptor_B:** `MET`
- **linker:** `GS_med`
- **candidate_id:** `FGFR2_MET__GS_med`
- **tier:** **TOP_K_DESIGN**
