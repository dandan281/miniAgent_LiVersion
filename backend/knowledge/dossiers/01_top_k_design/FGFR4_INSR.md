# Novokine candidate dossier — FGFR4 + INSR
_Generated from experience buffer record `53a57f2e-96e7-4f3f-9128-4de6caebb969` at 2026-05-04T07:07:21.548158+00:00 (mode=score_only)._

- **receptor_A:** `FGFR4`
- **receptor_B:** `INSR`
- **linker:** `GS_med`
- **candidate_id:** `FGFR4_INSR__GS_med`
- **tier:** **TOP_K_DESIGN**
